...
import { ModelScanProgress } from '../../components/ModelScanProgress';
import { AddEditLLMServiceDialog, LLMServiceFormData } from '../../components/shared/AddEditLLMServiceDialog';
...
export function SettingsPanel() {
  ...
  const handleSaveService = async (data: LLMServiceFormData) => {
    ...
    try {
      ...
      toast.error(editingService ? 'Failed to update LLM service' : 'Failed to add LLM service');
    }
  };
