                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span
                          className={`px-2 py-1 text-xs rounded-full text-white ${getModelTypeColor(model.modelType)}`}
                        >
                          {model.modelType}
                        </span>
                      </div>
            ...
            <div className="bg-gray-900 rounded-lg border border-gray-700 w-full max-w-md max-h-[80vh] overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <p className="text-sm text-gray-400">
                  Some models require a Hugging Face token to access. This
                  enables downloading gated models like Llama and Gemma.
                </p>
                ...
                <div className="flex items-start gap-2 text-xs text-gray-500">
                  ...
                  <span>
                    Token is stored on your server in the server configuration
                    directory, and only used for Hugging Face API requests.
                  </span>
                </div>
              </div>
            </div>
