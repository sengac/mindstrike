        ...
        <div className='flex-1'>
          ...
          <div className='space-y-1 text-sm'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <span className='text-gray-300'>
                {(model.loadingSettings?.contextSize || model.maxContextLength || model.contextLength || 4096).toLocaleString()} tokens
        ...
        <div className='mt-4 pt-4 border-t border-gray-600'>
          ...
          <div className='space-y-4'>
            <div>
              ...
              {!validationErrors.gpuLayers && (
                <div className='text-xs text-gray-500 mt-1'>
                  -1: Auto, 0: CPU only, 1-{model.layerCount || 100}: Specific layers
                </div>
              )}
            </div>
            ...
            <div>
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      />
                      <span className='text-xs text-gray-400 w-12'>
                      {tempSettings.threads === 0 || tempSettings.threads === undefined ? 'Auto' : 'cores'}
                      </span>
                      </div>
                    </>
                  )
              ...
              {!validationErrors.threads && (
                <div className='text-xs text-gray-500 mt-1'>
                  0: Auto, 1 - {Math.min(32, (navigator.hardwareConcurrency || 8) * 2)}{' '}
                  threads
                </div>
              )}
            </div>
