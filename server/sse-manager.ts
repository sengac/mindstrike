...
class SSEManager {
  ...
  private safeStringify(data: any): string {
    try {
      ...
      logger.error('Problematic data:', typeof data === 'object' ? JSON.stringify(data).substring(0, 1000) : String(data).substring(0, 1000));
  ...
  private sanitizeData(obj: any, depth = 0, maxDepth = 10): any {
