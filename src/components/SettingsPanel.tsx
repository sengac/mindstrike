                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <ul className="text-blue-300 space-y-1 text-xs">
                      ...
                      <li>
                        • Q4_K_M quantization provides good quality/performance
                        balance
                      </li>
                      <li>
                        • Larger models provide better quality but require more
                        resources
                      </li>
                    </ul>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-blue-900/20 border border-blue-600/30 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    <p className="text-blue-200 mb-2">
                      <strong>LLM Services:</strong> Connect to local and remote
                      AI services.
                    </p>
                    <ul className="text-blue-300 space-y-1 text-xs">
                      <li>
                      ...
                      <li>
                        • Manually add LLM services like OpenAI, Anthropic, or
                        custom endpoints
                      </li>
                      <li>
