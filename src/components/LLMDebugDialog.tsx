...
export function LLMDebugDialog({
  isOpen,
  onClose,
  initialTab = 'debug',
}: LLMDebugDialogProps) {
  ...
  const [activeTab, setActiveTab] = useState<'debug' | 'tasks' | 'mcp'>(
    initialTab
  );
    ...
    >
      ...
      {(activeTab === 'debug' || activeTab === 'mcp') && (
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          ...
          <button
            onClick={
              activeTab === 'debug' ? handleClearEntries : handleClearMCPLogs
            }
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {task.status === 'completed' &&
                              (task.details != null || task.result != null) && (
