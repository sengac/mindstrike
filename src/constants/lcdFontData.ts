// 5x8 dot matrix patterns for LCD characters
export const LCD_FONT_DATA: { [key: string]: number[] } = {
  ...
  J: [0x07, 0x02, 0x02, 0x02, 0x12, 0x12, 0x0c, 0x00],
  ...
  '●': [0x00, 0x00, 0x0e, 0x1f, 0x0e, 0x00, 0x00, 0x00],
