...
export function WorkspaceView({ onDirectoryChange }: WorkspaceViewProps) {
  const {
    files,
    loadFiles,
    loadDirectory,
  ...
  return (
    <div className="h-screen flex flex-col">
      {/* Header */}
      <AppBar icon={Folder} title="Workspace" />
      ...
      <div className="flex flex-1 min-h-0">
        ...
        >
          ...
          {/* Buttons underneath file list */}
          <div className="p-4 border-t border-gray-700">
            <div className="flex flex-col gap-5">
              <div>
                <p className="text-xs text-gray-400 mb-1 text-center">
                  Set this directory as your workspace for saving files
                </p>
                <button
                  onClick={handleSetWorkspaceRoot}
                  className="px-3 py-2 bg-blue-600 hover:bg-blue-700 rounded transition-colors text-white flex items-center justify-center gap-2 text-sm w-full"
                  title="Set current directory as workspace root"
                >
                  <Home size={16} />
                  <span>Set Workspace Root</span>
                </button>
              </div>
              <div>
                <p className="text-xs text-gray-400 mb-1 text-center">
                  Set this directory as your music library location
                </p>
                <button
        ...
        <div
          ...
          data-test-id="workspace-content"
        >
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <div className="flex flex-col">
                          <div className="flex items-start gap-1">
                            ...
                            <span>
                              Select a folder to load MindStrike Chats, MindMaps
                              and working files from
                            </span>
                          </div>
                        </div>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        <div className="flex flex-col">
                          <div className="flex items-start gap-1">
                            ...
                            <span>
                              The Music Player will scan all subdirectories of
                              this folder for compatible audio files
                            </span>
                          </div>
                        </div>
                      </li>
