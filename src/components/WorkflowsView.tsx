      ...
      {activeWorkflow ? (
        <div className="flex flex-col h-full">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Created: {activeWorkflow.createdAt.toLocaleDateString()} | Last
              updated: {activeWorkflow.updatedAt.toLocaleDateString()}
            </p>
          </div>
          ...
          <div className="flex-1 bg-gray-800 rounded-lg p-6">
            <div className="flex items-center justify-center h-full text-gray-500">
              <div className="text-center">
                ...
                <p className="text-lg">
                  Workflow content will be displayed here
                </p>
                <p className="text-sm mt-2">
                  This is where you can design and configure your workflow
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-center h-full text-gray-500">
          <div className="text-center">
            ...
            <p className="text-sm mt-2">
              Choose from the list on the left or create a new workflow
            </p>
          </div>
        </div>
      )}
