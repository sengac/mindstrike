...
interface MockLlamaModel extends Partial<LlamaModel> {
  dispose: MockedFunction<() => Promise<void>>;
}

interface MockLlamaContext extends Partial<LlamaContext> {
  dispose: MockedFunction<() => Promise<void>>;
}

interface MockLlamaChatSession extends Partial<LlamaChatSession> {
